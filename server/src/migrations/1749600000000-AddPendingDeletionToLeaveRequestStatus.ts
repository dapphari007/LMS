...
export class AddPendingDeletionToLeaveRequestStatus1749600000000 implements MigrationInterface {
    public async up(queryRunner: QueryRunner): Promise<void> {
        // Add the new enum value to the leave_request_status_enum type
        await queryRunner.query(`
            ALTER TYPE leave_request_status_enum ADD VALUE IF NOT EXISTS 'pending_deletion';
        `);
    }
